      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 w-full max-w-6xl">
            ...
            >
              <motion.h3 
                className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent relative"
              ...
              <div className="flex flex-col space-y-6">
                {navigationItems.map((item, index) => (
                  <motion.button
                    ...
                    className="group relative px-8 py-4 bg-gradient-to-r from-gray-800/50 to-gray-700/50 rounded-2xl border border-gray-600/30 hover:border-purple-500/50 transition-all duration-500 backdrop-blur-sm"
                    whileHover={{ 
                      scale: 1.05,
                      rotateY: 5,
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center justify-center space-x-3">
                      ...
                      <span className="text-xl font-semibold text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-300 group-hover:to-pink-300 group-hover:bg-clip-text transition-all duration-300">
                        {item.name}
                      </span>
                    </div>
            ...
            >
              <motion.h3 
                className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent relative"
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.3 }}
              >
                Explore
              ...
              <div className="grid grid-cols-3 gap-6">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="group relative p-6 rounded-2xl bg-gradient-to-br from-gray-800/60 to-gray-700/60 border border-gray-600/30 hover:border-purple-500/50 transition-all duration-500 backdrop-blur-sm"
                    whileHover={{ 
                      scale: 1.15,
                      rotateY: 10,
                      rotateX: 5,
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      style={{
                        background: `linear-gradient(45deg, ${['#8B5CF6', '#EC4899', '#3B82F6', '#10B981', '#F59E0B', '#EF4444'][index % 6]}40, transparent)`
                      }}
                      animate={{
                        scale: [1, 1.2, 1],
                        rotate: [0, 180, 360]
                    ...
                    {/* Enhanced Tooltip */}
                    <motion.div 
                      className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none shadow-lg"
                      whileHover={{ scale: 1.05 }}
                    >
                      {social.name}
        ...
        >
          <motion.p 
            className="text-gray-400 text-lg md:text-xl relative"
